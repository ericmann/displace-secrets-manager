...
The provider interface is designed for this. Third-party provider plugins can register during the `secrets_register_providers` action. First-party provider plugins are planned.
